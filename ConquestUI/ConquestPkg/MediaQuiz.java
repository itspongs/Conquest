...
public class MediaQuiz {
    ...
    public MediaQuiz(JFrame frame, String playerName) {
        ...
        JLabel catLabel = new JLabel("Category: Media");
    ...
    private void showLoadingScreen() {
        ...
        JLabel category = new JLabel("Category: Media");
    ...
    private ImageIcon loadImage(String path) {
        ...
        if (url != null) {
            System.out.println("[MediaQuiz] Loaded via classloader: " + url);
            return new ImageIcon(url);
        }

        url = getClass().getResource("/" + path);
        if (url != null) {
            System.out.println("[MediaQuiz] Loaded via getResource: " + url);
            return new ImageIcon(url);
        }

        File f = new File(path);
        if (f.exists()) {
            System.out.println("[MediaQuiz] Loaded via working dir: " + f.getAbsolutePath());
        ...
        try {
            ...
            if (fromCode.exists()) {
                System.out.println("[MediaQuiz] Loaded via code base: " + fromCode.getAbsolutePath());
                return new ImageIcon(fromCode.getAbsolutePath());
            }
        } catch (Exception ignored) {}

        System.err.println("[MediaQuiz] FAILED to load image: " + path);
    ...
    private void showQuestion() {
        ...
        JLabel catLbl = new JLabel("CATEGORY: Media");
    ...
    private void handleAnswer(int selected, JButton[] buttons, boolean[] filled, boolean[] locked, Question q) {
        ...
        new javax.swing.Timer(1200, e -> {
            ...
            if (currentIndex < quizQuestions.size()) {
                ...
                stopMusic();
                new QuizResults(frame, playerName, score, quizQuestions.size(), "Media");
            }
        }).start();
    }
    ...
    private void loadQuestions() {
        ...
        String[][] data = {
            ...
            { "", // Question
              ...
              "", // Choice C
              "", // Choice D
              "", "images/Media/31.png" }, //Correct Letter //number.png
            ...
            { "", // Question
              ...
              "", // Choice C
              "", // Choice D
                "", "images/Media/  " }, //Correct Letter //number.png
        };
