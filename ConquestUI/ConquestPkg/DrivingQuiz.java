...
public class DrivingQuiz {
    ...
    // ── Theme colors ──────────────────────────────────────────────
    private static final Color BG_DARK    = new Color(139, 0, 0);      // deep red background
    private static final Color BG_DARKER  = new Color(110, 0, 0);      // slightly darker red
    private static final Color BTN_NORMAL = new Color(188, 74, 74);    // pinkish-red button
    private static final Color BTN_HOVER  = new Color(210, 110, 110);  // lighter on hover
    ...
    private void showQuestion() {
        ...
        // ── TOP BAR: ConQuest left, Category right ────────────────
        ...
        // Wrap main in a background panel
    ...
    private void handleAnswer(int selected, JButton[] buttons, boolean[] filled, boolean[] locked, Question q) {
        ...
        // color all buttons to default first
